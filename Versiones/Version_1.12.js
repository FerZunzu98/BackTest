...
async function Bucle (resolution){
    ...
    console.log(jugadas[5]);
    console.log(jugadas[6]);
    console.log(jugadas[7]);
    console.log(jugadas[8]);
    console.log(jugadas[9]);
...
async function VBS_1 (array_datos,accion){
    ...
    for(i=200; i < array_datos.c.length; i++){
        ...
        if(MM20 > MM20_10 && MM20_10 > MM20_20 && MM8 > MM8_3 && MM8_3 > MM8_5 && high < high_1 && high_1 < high_2 && high < MM200){
        ...
        if(MM20 < MM20_10 && MM20_10 < MM20_20 && MM8 < MM8_3 && MM8_3 < MM8_5 && low > low_1 && low_1 > low_2 && low > MM200){
